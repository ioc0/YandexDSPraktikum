...
for genre in selected_genres:
    new_data = filter_by_genre(oscar_data,genre)
    ...
    mean_score = column_mean(new_data,2)

    # средняя длина (индекс столбца 3)
    mean_length = column_mean(new_data,3) # < напишите код здесь >

    # среднее значение ROI (индекс столбца 7)
    mean_roi =  column_mean(new_data,7)# < напишите код здесь >

    # средняя цена за минуту (индекс столбца 8)
    mean_ppm =  column_mean(new_data,8)# < напишите код здесь >
