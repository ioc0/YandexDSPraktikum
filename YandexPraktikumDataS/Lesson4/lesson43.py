...
Посчитаем суммарные бюджет и сборы фильмов из таблицы. Напишите функцию column_sum(), которая получает на вход таблицу и
номер столбца, и возвращает сумму значений по этому столбцу.
Используйте эту функцию, чтобы напечатать результат в таком формате:
Скопировать код
...
column_sum(oscar_data,5)
total_people = 7539
print('Каждый человек в среднем потратил ${:.2f} на фильмы, получившие "Оскар".'
      .format(column_sum(oscar_data,6)/total_people))